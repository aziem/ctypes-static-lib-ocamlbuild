...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4ec52f10b3e3c010e14ad4c44c217d7d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "Ctypes bindings example with C static library";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "test"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "testlib.ml"})
            ];
     ...
     oasis_digest = Some "\011\152\172\to\205\181x\0026z\195\165\165\173\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
